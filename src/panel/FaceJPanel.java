...
public class FaceJPanel extends JPanel {
	...
	private void init() {
		...
		labelCountG.setIcon(StaticElements.time[0]);
		labelCountS.setIcon(StaticElements.time[1]);
		labelCountB.setIcon(StaticElements.time[0]);
	...
	/*public class FaceLableListener extends MouseAdapter {
		...
		public void mousePressed(MouseEvent e) {
			if (e.getModifiers() == InputEvent.BUTTON1_MASK) {
				labelFace.setIcon(StaticElements.downSmileIcon);
		...
		public void mouseReleased(MouseEvent e) {
			if (e.getModifiers() == InputEvent.BUTTON1_MASK) {
				...
				labelFace.setIcon(StaticElements.smileIcon);
			}
		}
